...
<section id="home">
    <div id="main-slide" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="static-carousel-image" style="background-image: url('assets/images/SlideStarEffect_1.gif');">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-md-block">
                        ...
                        <h5 class="animated fadeInUp wow hero-sub-heading" data-wow-delay=".6s">Change Everything</h5>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <h1 class="animated wow fadeInLeft hero-heading" data-wow-delay=".7s">Investment for All</h1>
                        <h5 class="animated wow fadeInRight hero-sub-heading" data-wow-delay=".9s">Opening ownership to
                            high
                            value assets</h5>
                        <a href="javascript:void(0)" class="animated fadeInUp wow btn btn-common"
                           data-wow-delay=".6s"><i
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <h1 class="animated wow fadeInDown hero-heading" data-wow-delay=".6s">Legal Meets Fintech</h1>
                ...
                <div class="Material-tab">
                    ...
                    <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#finance" role="tab"><i
                                    class="icons_new"><img src="assets/images/icons/financeicon.png" alt=""></i> <br>Finance</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#technology" role="tab"><i
                                    class="icons_new"><img src="assets/images/icons/technologyicon.png" alt=""></i> <br>Technology</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#businessdevelopment" role="tab"><i
                                    class="icons_new"><img src="assets/images/icons/businessdevelopmenticon.png" alt=""></i>
                                <br>Business</a>
                        </li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="finance" role="tabpanel">
                            <p>The financial industry has always been controlled by the wealthiest of society in that
                                many investments are too valuable for even the upper middle class to reasonably invest.
                                ...
                                opportunities. We are removing these barriers by allowing for fractional ownership of
                                assets through crowdfunding methods.</p>

                        </div>
                        <div class="tab-pane fade" id="technology" role="tabpanel">
                            <p>Blockchain technology allows us to be able to manage fractional ownership opportunities
                                in several ways. First, open ledgers allow for all transactions to be open and honest,
                                allowing for all investors to be aware of exactly what they are receiving and that no
                                ...
                                process of a traditional shareholders meeting. Third, blockchain governance allows for
                        ...
                        <div class="tab-pane fade" id="legal" role="tabpanel">
                            <p>Many financial and technology institutions begin their projects with the best intentions
                                of mind without looking into future potential legal ramifications for their projects or
                                how current laws can bottleneck their development. We take the law seriously and it is
                                even a necessary element to our business. Progress in current law is a key element to
                                adapting new technology in society, and we actively find the best ways to be compliant
                        ...
                        <div class="tab-pane fade" id="businessdevelopment" role="tabpanel">
                            <p>Many technology companies focus only on their tech and ignore the business aspect of
                                ...
                                priority. Without having a strong symbiotic relationship with our users and partners,
                                building our technology will be for nothing. Our growth plan is focused on bringing
                                highly qualified users and partners to our platform, with the end goal of having mass
            ...
            <div class="col-md-6 col-lg-4 col-xl-4 single-service-widget wow animated fadeInUp" data-wow-delay=".7s">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p>The world needs food, and we are looking towards the most advanced farming methods to bring
            ...
            <div class="col-md-6 col-lg-4 col-xl-4 single-service-widget wow animated fadeInUp" data-wow-delay=".8s">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p>Want to help out with some of your investment? We have charitable options for you to do your
                            part.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="testimonial-item">
                        <div class="datils">
                            ...
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                                has been the industry's <br> standard dummy text ever since the 1500s Lorem Ipsum.</p>
                        </div>
                        <div class="img">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mt-3 contact-widget-section2 wow animated fadeInLeft" data-wow-delay=".2s">
                <p>If you are looking to partner with us, want to learn more about our IEO, or any general questions you
